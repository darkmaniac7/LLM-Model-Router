...
MODELS = {
    ...
    "behemoth-r1-123b-iq4nl": {
        "backend": "llamacpp",
        "script": "/home/ivan/sglang/start_llamacpp_behemoth_blackwell.sh",
        "service": "llamacpp.service"
    },
    "magnum-diamond-123b-iq4nl": {
        "backend": "llamacpp",
        "script": "/home/ivan/sglang/start_llamacpp_magnum_blackwell.sh",
        "service": "llamacpp.service"
    },
    }
}
...
async def switch_to_tabby_model_streaming(model_id: str, model_info: dict):
    ...
    try:
        ...
        if model_name:
            config_path = "/home/ivan/tabbyAPI/config.yml"
            try:
